...
public class StringArrangement {
    public static void main(String[] args) {
        String t = "";
        ...
        System.err.println("result: " + checkStringArrangement0(t, s));
//        System.err.println("result: " + checkStringArrangement("ab", "eidboaoo"));
    }

    public static boolean checkStringArrangement0(String substring, String string) {
        ...
        for (int right = 0; right < string.length(); right++) {
            ...
            if (need.containsKey(c)) {
                ...
                matches = 0;
                Iterator<Map.Entry<Character, Integer>> iterator = window.entrySet().iterator();
    ...
    public static boolean checkStringArrangement(String substring, String string) {
//        if (substring == null || string == null
//                || substring.length() > string.length()) {
//            return false;
//        }
...
//                }
            ...
            while (right - left >= substring.length()) {
                if (matches == need.size()) {
                    return true;
                }
                char leftChar = string.charAt(left);
